package c.odonfrancisco.downloadingimages;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void downloadImage(View view){
        ...
        try{
            myImage = task.execute("https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Macaca_sinica_-_01.jpg/220px-Macaca_sinica_-_01.jpg").get();
